...
const { toggleFollow, toggleLike, addComment, getComments, getFeed, addFriendByCode,getFriends ,getFriendProfile,toggleFistBump,addPrivateComment} = require('../controllers/socialController');
